...
### Solution Proposed for problem statement
...
## STEPS FOR RUNNING IT IN YOUR LOCAL MACHINE.
Before we run the project, make sure that you are having MongoDB in your local system preferably with MongoDB Compass,since we are using MongoDB for data storage.
...
```bash
git clone https://github.com/sinoymanna/sensor-fault-detection.git
```
